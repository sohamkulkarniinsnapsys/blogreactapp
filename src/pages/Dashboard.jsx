...
import { getCurrentUser, getPosts, deletePost, updatePost, getFileViewUrl } from "../services/appwrite";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((p) => (
            <div key={p.$id} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow hover:shadow-lg transition">
              ...
              <p className={`inline-block px-2 py-1 text-xs font-semibold rounded ${getStatusColor(p.status)} mb-2`}>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {editPreview && <img src={editPreview} alt="Preview" className="mt-2 w-full h-48 object-cover rounded" />}
              </div>
              <div>
